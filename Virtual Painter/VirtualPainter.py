...
myListDirectory = os.listdir("D:\OSN INFORMATIKA\Phyton AI\Virtual Painter\header")
print(myListDirectory)
overlayList = []

for imPath in myListDirectory:
    image = cv2.imread(f'D:\OSN INFORMATIKA\Phyton AI\Virtual Painter\header\{imPath}')
